...
While the Svelvet component can now fill the size of its wrapping container, we want to improve the logic about node postioning and graph scale on window resize.
