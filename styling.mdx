...
<Tip>
  You can style parameters beyond those available here by using global
  selectors. :global(.svelvet-node) selects applies to all Nodes, for instance.
  Will add all internal class names with time!
</Tip>
