...
Canvases are composed structurally by passing [Group](/components/group), [Nodes](/components/node) and other components as children to the [Svelvet](/components/svelvet) component. Standard Svelte syntax applies for conditional rendering and iteration to place Nodes on the canvas.
...
<iframe
  src="https://stackblitz.com/edit/vitejs-vite-kjkfsp?embed=1&file=src/routes/+page.svelte&view=preview"
