...
Canvases are composed structurally by passing Groups, Nodes and other components as children to the Svelvet component. Standard Svelte syntax applies for conditional rendering and iteration to place Nodes on the canvas.
...
Edges, the connections between Anchors, can be specified ahead of time or dynamically and fully customized.
...
<iframe
  src="https://stackblitz.com/edit/vitejs-vite-kjkfsp?embed=1&file=src/App.svelte"
