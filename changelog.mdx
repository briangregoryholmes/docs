...
- Added the ability to pass custom edges at the canvas, Node and Anchor level
...
- Added ability to parse Mermaid strings into node canvass + edges
- Added the ability to specify canvas direction as TD or LR
...
- Made progress on restoring canvas state from local storage. Coming very soon!
