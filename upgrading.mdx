...
The equivalent to UserNodeType is NodeConfig. There is also a type "Node" for the structure of the actual Node in the store. We will be adding extensive type definitions to our documentation soon, but mostly everything developers need is included in the prop definitons for each component.
